 ...
 */
// export let fileSuffixName = (fileName) => {
//     return (function () {
//         let fileName;
//         if (fileName != '') {
//             let rex = /mzqhdm\_\d{8}\.zip/;
//             if (!res.text(fileName)) {
//                 openNotificationWithIcon("error", "请选择正确的文件进行上传!");
//             }else{
                
//             }
//         } else {
//             openNotificationWithIcon("error", "请选择一个文件再进行上传");
//         }
//     })();
// }
