        ...
        return (
            <div className="a">
                ...
                <div className="button-group">
                    ...
                    <Button type="primary" size="large" disabled={this.state.isDisabled} >审核通过</Button>

                    <Button type="primary" size="large" disabled={this.state.isDisabled} >审核不通过</Button>
                    <Button type="primary" size="large">刷新</Button>
                </div>
                {/*分割线*/}
